/** @file drv_softi2c_bq769x0.h
 *  @brief BQ769x0 电池监测芯片驱动接口。
 *  @details 封装芯片初始化、寄存器配置、采样读取和告警回调注册。
 *  @par 使用方法 构造 InitData 后调用 BQ769X0_Initialize()，周期读取 BQ769X0_SampleData。
 */
